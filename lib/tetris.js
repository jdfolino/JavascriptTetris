...
function Tetris(grid, starting_interval, pieceQueue) {
    ...
    this.rotateClockwise = function (piece) {
        return this.tryMove(piece, 'ROTATE_CLOCKWISE');
    };

    this.rotateAntiClockwise = function (piece) {
        return this.tryMove(piece, 'ROTATE_ANTI_CLOCKWISE');
    };

    this.moveDown = function(piece) {
        return this.tryMove(piece, 'DOWN');
    };

    this.moveLeft = function(piece) {
        return this.tryMove(piece, 'LEFT');
    };

    this.moveRight = function(piece) {
        return this.tryMove(piece, 'RIGHT');
    };
    ...
    function squaresAlreadyOccupied(piece, x_transformation, y_transformation) {
     ...
     this.tryMove = function(piece, commandKey) {
        var COMMANDS = {
        ...
        var clone = this.activePiece.clone();
        clone[command.move]();
