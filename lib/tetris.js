...
function Tetris(grid, starting_interval) {
    ...
    this.rotateClockwise = function (piece) {
        return tryMove(piece, 'ROTATE_CLOCKWISE');
    };

    this.rotateAntiClockwise = function (piece) {
        return tryMove(piece, 'ROTATE_ANTI_CLOCKWISE');
    };

    this.moveDown = function(piece) {
        return tryMove(piece, 'DOWN');
    };

    this.moveLeft = function(piece) {
        return tryMove(piece, 'LEFT');
    };

    this.moveRight = function(piece) {
        return tryMove(piece, 'RIGHT');
    };
    ...
    function tryMove(piece, commandKey) {
        var COMMANDS = {
