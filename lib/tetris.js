...
function Tetris(grid, starting_interval) {
    ...
    this.rotateClockwise = function (piece) {
        return this.tryMove(piece, GAME_MOVES.ROTATE_CLOCKWISE)
    }

    this.rotateAntiClockwise = function (piece) {
        return this.tryMove(piece, GAME_MOVES.ROTATE_ANTI_CLOCKWISE)
    }

    this.moveDown = function(piece) {
        return this.tryMove(piece, GAME_MOVES.DOWN)
    }
